...
function addImage(src){
	...
	if(arr.error == 0){
		//上传成功
		 layer.msg("上传成功");
		 var newElement = "<input type='hidden' name='"+arr.divid+"[]' value='"+arr.info+"'>";
		 $("#"+arr.id).val(arr.info);//赋值给指定的文本框
		 $("#"+arr.id).attr("data-image",arr.info);//赋值给指定的文本框 的显示问题
		 $("#div_"+arr.divid).append(newElement);
